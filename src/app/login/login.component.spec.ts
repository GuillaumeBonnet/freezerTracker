...
describe('LoginComponent', () => {
	...
	it('should log in', () => {
		let usernameInput: HTMLInputElement =
			component.querySelector('input#username')
		usernameInput.value = 'userName2'
		usernameInput.dispatchEvent(new Event('input'))

		// no password -> no querry
		let passwordInput: HTMLInputElement =
			component.querySelector('input#password')
		passwordInput.value = ''
		passwordInput.dispatchEvent(new Event('input'))
		let logButton: HTMLElement = component.querySelector(
	...
	it('register button should navigate to register page', () => {
		let registerButton: HTMLElement = component.querySelector(
	...
	it('reset password button should navigate to its page', () => {
		let resetPasswordButton: HTMLElement = component.querySelector(
