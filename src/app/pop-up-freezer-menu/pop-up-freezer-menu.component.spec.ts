...
describe('PopUpFreezerMenuComponent', () => {
	describe('with testHostComponent', () => {
		...
		let matDialogData = {selectedFreezer: new Freezer({name:"freezerName"})};
		...
		beforeEach(async(() => {
			...
			component = fixture.debugElement.query(By.css('app-pop-up-freezer-menu'));
		}));
		...
		it('should display the name', () => {
			expect(component.query(By.css('h2')).nativeElement.textContent)
